...
For questions about *ro_research1*, a table showing the ptstatus, Fitbit date, and the total number of steps and how far off the user was from their goal for all users every day is shown below.  
```
+---------+----------+-------------+--------------+--------------------+
